    ...
    trigger('itemAnim', [
      ...
      transition('void => *', [
        ...
        style({
          ...
          // we want to 'expand' out the padding properties
          paddingTop: 0,
          paddingBottom: 0,
          paddingRight: 0,
          paddingLeft: 0,
        }),
        // we first want to animate the spacing (which includesheight and margin)
        animate(
          '50ms',
          style({
            height: '*',
      ...
      transition('* => void', [
        ...
        //scale down and fadeout completely
        animate(
          '120ms ease-out',
          style({
...
export class NotesListComponent implements OnInit {
  ...
  filter(query: string) {
    ...
    //because a particular notecan be the result of many search terms
  ...
  sortByRelevancy(searchResults: Note[]) {
    //this method will calcualtethe relevancy of a note based on the number of times
